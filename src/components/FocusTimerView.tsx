    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-slate-400">
          Pomodoro technique: work deeply with zero distractions, then rest.
        </p>
      </div>
            ...
            <div className="space-y-1.5 max-h-60 overflow-y-auto pr-1">
              {subjects.map((s) => (
                ...
                >
                  ...
                  {s.isFinished && <span className="text-[10px] text-slate-500">(Done)</span>}
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-slate-800">
            <div className="p-3.5 rounded-2xl bg-slate-950 border border-slate-800">
              ...
              <p className="text-xl font-black text-amber-400 mt-0.5">
                {timerCompletedSessionsCount} Sessions
              </p>
              <p className="text-[10px] text-slate-500 mt-1">
                Total: {timerCompletedSessionsCount * timerPresetMins} mins
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4 z-10">
            {timerIsRunning ? (
              <button
                ...
                className="flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-amber-500 hover:bg-amber-600 text-slate-950 font-black text-sm shadow-xl shadow-amber-500/20 transition transform active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black text-sm shadow-xl shadow-blue-500/30 transition transform active:scale-95"
              >
